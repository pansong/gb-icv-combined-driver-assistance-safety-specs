...
**5.5.2.1** 如图25所示，在日间条件下，试验道路为包含不少于3个出入口的环形路口，路口内至少包含两条车道，路口每个出入口至少为双向单车道，试验车辆入口上游存在一动态车辆目标，下游第一个入口存在静态车辆目标。
...
**5.5.5.1.3** 试验车辆取消或完成本次换道过程后，试验结束。
